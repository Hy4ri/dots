...
web() {
    search=$(rofi -dmenu -i -p "Google Web:" -theme ${dir}/${theme}.rasi)
...
image() {
    search=$(rofi -dmenu -i -p "Google images:" -theme ${dir}/${theme}.rasi)
...
map() {
    search=$(rofi -dmenu -i -p "Google Maps:" -theme ${dir}/${theme}.rasi)
...
video() {
    search=$(rofi -dmenu -i -p "Google videos:" -theme ${dir}/${theme}.rasi)
...
CHOICE=$(for item in "${MENU_ITEMS[@]}"; do
    ...
    echo "$label"
done | rofi -dmenu -p "search" -i -theme ${dir}/${theme}.rasi)
