...
keymap.set("i", "<left>", '<cmd>echo "Use h to move!!"<CR>', opts)
keymap.set("i", "<right>", '<cmd>echo "Use l to move!!"<CR>', opts)
keymap.set("i", "<up>", '<cmd>echo "Use k to move!!"<CR>', opts)
keymap.set("i", "<down>", '<cmd>echo "Use j to move!!"<CR>', opts)
...
keymap.set("n", "<leader>fm", "<cmd> Oil <cr>", opts)
